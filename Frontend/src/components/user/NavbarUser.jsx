      ...
      <div className="navbar bg-base-100 shadow-sm">
        ...
        <div className="navbar-end gap-2">
          ...
          <div className="form-control">
            <label className="input input-bordered flex items-center gap-2 rounded-full bg-[#1a2e54] border-none text-gray-400 w-full max-w-xs lg:max-w-md lg:w-80 transition-all duration-300">
              <svg
